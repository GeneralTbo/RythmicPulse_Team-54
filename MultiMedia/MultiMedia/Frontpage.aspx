<%@ Page Title="" Language="C#" MasterPageFile="~/WebPages/ClientMaster.Master" AutoEventWireup="true" CodeBehind="Frontpage.aspx.cs" Inherits="MultiMedia.Frontpage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="wrap" style="border:solid #d4ba20;background-color:#d4ba20;width:auto;">
        <div >
            <div >
                ...
                <br />
                <div class="section group " style="background-color:black">
                      <div class="section group" style="width:100%">
                       
                       
                         <div class="content_top">
                                 <div class="product-desc" style="margin-top: -20px;">
                                    <h2 style="color:#d4ba20">Available Bookings</h2>
                                </div>
                            </div>
    ...
    <!-- #endregion Jssor Slider End -->  <div class="content_top">
                                 <div class="product-desc" style="margin-top: -20px;">
                                <h2 style="color:#d4ba20;font-weight:bold">OFFERS</h2>
                                </div>
                              
                            </div>
                    <div class="grid_1_of_4 " id="jssor_1" style="position: relative; width: 1300px; height: 500px; overflow: hidden; visibility: hidden;">
        <!-- Loading Screen -->
        ...
        <a href="http://www.jssor.com" style="display:none">Slideshow Maker</a>
                ...
                <div class="section group" style="background-color:black;">
                       <div class="grid_1_of_4 " style="width:49%; height:250px">
                        <div class="content_top">
                                 <div class="product-desc" style="margin-top: -20px;">
                                <h2 style="color:#d4ba20;font-weight:bold">MEMBERSHIPS</h2>
                                </div>
